...
while True : 
	...
	while gamestate1:
		...
		if deneme ==0:
			cv2.putText(img = image, text = "Press SPACE to start", org = (150,150), fontFace = cv2.FONT_HERSHEY_DUPLEX, fontScale = 1.0, color = (0,0,255), thickness = 3)
		...
		if deneme:
			if (time.time() - starttime) < 1:
				...
				cv2.putText(img = image, text = "GO!", org = (50,150), fontFace = cv2.FONT_HERSHEY_DUPLEX, fontScale = 2.0, color = (0,255,0), thickness = 3)
				gamestate2 = 1
				gamestate1  = 0
